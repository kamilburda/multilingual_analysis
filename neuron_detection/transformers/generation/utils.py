    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        if return_dict_in_generate:
            ...
            return hidden_token_cont, input_ids, activate_keys_fwd_up, activate_keys_fwd_down, activate_keys_q, activate_keys_k, activate_keys_v, activate_keys_o, layer_keys
